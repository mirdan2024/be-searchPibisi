...
public class Scoring {
	...
	public InfoScoring getInfo() {
		return info;
	}

	public void setInfo(InfoScoring info) {
		this.info = info;
	}
	...
	public long getWasPepDate() {
		return wasPepDate;
	}

	public void setWasPepDate(long wasPepDate) {
