...
public class PdfService extends BaseService {
	...
	private void getPageCover(StringBuilder builder) {
		...
		builder.append("<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"90%\" align=\"center\">");
		builder.append("<tr>");
		builder.append("<td height=\"100px\"></td>");
		builder.append("</tr>");
		builder.append("<tr>");
		builder.append("<td style=\"text-align: center;\">");
		builder.append("<img width=\"100\" height=\"115\" src=\"" + imageLogo.toString() + "\">");
		builder.append("</td>");
		builder.append("</tr>");
		builder.append("<tr>");
		...
		builder.append("<tr>");
		builder.append("<td style=\"text-align: center;\">");
		builder.append("<img width=\"620\" height=\"520\" src=\"" + imageCover.toString() + "\">");
		builder.append("</td>");
		builder.append("</tr>");
		builder.append("<tr>");
